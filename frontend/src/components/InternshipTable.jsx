              ...
              <form onSubmit={handleSubmit}>
                <div className="form-grid">
                  ...
                  <div className="flex-column">
                    ...
                    <div className="inputForm">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" width="20" height="20">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21h10.5V6.75H6.75V21Zm0 0h10.5V6.75H6.75V21Z" />
                      </svg>
                      <input
                        type="text"
                        name="companyName"
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 12 }}>
                  ...
                  <button type="button" className="btn btn-secondary" onClick={closeModal} style={{ width: '100%', height: 48, borderRadius: 10 }}>
                    Cancel
                  </button>
                </div>
              </form>
